...
#if 0
    unsigned char macAddress[] = {0x70, 0x25, 0x59, 0x62, 0x69, 0x44};
    gAirTunesServiceInfo.setMacAddress(macAddress, 6);                      // 本机网卡MAC地址
#else
    //gAirTunesServiceInfo.setDeviceId("EC:88:8F:C0:44:9E");          // HP-WIN7
    //gAirTunesServiceInfo.setDeviceId("00:21:6a:b8:a7:34");
    //gAirTunesServiceInfo.setDeviceId("11:3f:FF:01:60:F9");
    //gAirTunesServiceInfo.setDeviceId("68:DF:DD:64:02:D8");        // m3
    //gAirTunesServiceInfo.setDeviceId("70:25:59:62:69:44");
    //gAirTunesServiceInfo.setDeviceId("00:15:18:01:81:31");          // TV
    gAirTunesServiceInfo.setDeviceId("70:25:59:62:69:44");       // TV wifi
#endif
    gAirTunesServiceInfo.setDeviceName("ViddaTV");                             // 机器名称
