...
AirMirroringServer              gAirMirroringServer;
...
class MyAirMirroringServerListener : public AirMirroringServerListener
{
public:
    MyAirMirroringServerListener() {}
    virtual ~MyAirMirroringServerListener() {}
...
MyAirMirroringServerListener    gMyAirMirroringServerListener;
...
int main(int argc, char *argv[])
{
    ...
    gAirMirroringServer.start(&gMyAirMirroringServerListener);
