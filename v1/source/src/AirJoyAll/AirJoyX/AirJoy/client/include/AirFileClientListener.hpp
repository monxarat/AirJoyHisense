...
#ifndef __AIRFILE_CLIENT_LISTENER_H__
#define __AIRFILE_CLIENT_LISTENER_H__
...
namespace airjoy
{
    ...
    class AIRJOY_API AirFileClientListener
    {
    public:
        AirFileClientListener() {}
        virtual ~AirFileClientListener() {}
...
#endif // __AIRFILE_CLIENT_LISTENER_H__
