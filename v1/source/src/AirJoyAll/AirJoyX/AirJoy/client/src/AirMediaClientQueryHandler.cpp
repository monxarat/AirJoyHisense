/*
 *
 * AirMediaClientQueryHandler.cpp
 *
...
AirMediaClientQueryHandler::AirMediaClientQueryHandler(AirMediaClient *client, AirMediaClientQueryListener *listener)
    : m_client(client)
	, m_listener(listener)
{
}

AirMediaClientQueryHandler::~AirMediaClientQueryHandler()
{
}

void AirMediaClientQueryHandler::didReceiveMessage(TcpClientMessagePointer p)
{
    if (m_listener == NULL)
        return;
...
void AirMediaClientQueryHandler::addBuffer(TcpClientMessagePointer p)
{
...
bool AirMediaClientQueryHandler::handleBuffer(const std::string &serverIp)
{
    bool result = true;
...
int AirMediaClientQueryHandler::getSessionId(const std::string &message)
{
    int sessionId = 0;
...
int AirMediaClientQueryHandler::getQuerySessionId(const std::string &stringSessionId)
{
    int sessionId = 0;
...
void AirMediaClientQueryHandler::didHandleHttpResponse(const std::string &serverIp, HttpMessagePointer pHttpResponse)
{
...
void AirMediaClientQueryHandler::didHandleHttpRequest(const std::string &serverIp, HttpMessagePointer pHttpResquest)
{
...
void AirMediaClientQueryHandler::didHandlePubsubResult(const std::string &serverIp, const std::string &action, const std::string &param)
{
...
void AirMediaClientQueryHandler::didHandleQueryResult(int sessionId, const std::string &action, const std::string &param)
{
    // 照片消息
