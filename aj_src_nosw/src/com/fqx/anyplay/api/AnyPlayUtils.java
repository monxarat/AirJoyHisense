...
public class AnyPlayUtils {
  ...
  public static AudioInfo gAudioInfo = new AudioInfo();
  public static volatile boolean is_anyplay = false;
  private static String mMacString = null;

  public static  final String ACTION_SERVER_STATE 		= "com.fqx.airjoy.state";
  public static  final String ACTION_SERVER_SLIDESHOW 	= "com.fqx.airjoy.slideshows";
  public static  final String ACTION_HX_EXIT 			= "are.you.ready";
  public static  final String ACTION_HS_SW 				= "com.hisense.multiscreenservice";
  public static  final String ACTION_HS_NAME 			= "com.hisense.TVname.CHANGE";
